...
public struct ChartTableToolbarFeature<T: Equatable & Sendable>: Sendable {
    ...
    public enum Action: Equatable, Sendable {
        ...
        case setSelectorOptions(selectorId: Selectors, option: [GenieCommonDomain.Dimension.Option])
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: 16) {
                ...
                ForEach(store.selectors, id: \.id) { selector in
                    ...
                    } onMultiSelectDissapear { options in
...
struct FilterPill: View {
    ...
    let onMultiSelectDissapear: (([GenieCommonDomain.Dimension.Option]) -> Void)? = nil
    ...
    init(
        ...
        onMultiSelectDissapear: (([GenieCommonDomain.Dimension.Option]) -> Void)? = nil
    ) {
        ...
        self.onMultiSelectDissapear = onMultiSelectDissapear
        _selectedId = State(
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showingModal) {
            if let dim = dimension {
                ...
                .onDisappear {
                    if updated.allowsMultiselect {
                        onMultiSelectDissapear?(updated.selectedOptions)
                    }
                }
            } else {
                EmptyView()
